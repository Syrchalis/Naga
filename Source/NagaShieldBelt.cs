...
namespace SyrNaga
{
    ...
    public class NagaShieldBelt : Apparel
    {
        ...
        private void AbsorbedDamage(DamageInfo dinfo)
        {
            ...
            FleckMaker.Static(base.Wearer.TrueCenter(), base.Wearer.Map, FleckDefOf.ExplosionFlash, num);
            int num2 = (int)num;
        ...
        private void Break()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                FleckMaker.ThrowDustPuff(loc, base.Wearer.Map, Rand.Range(0.8f, 1.2f));
                FleckMaker.ThrowLightningGlow(base.Wearer.TrueCenter(), base.Wearer.Map, 2f);
            }
            this.energy = 0f;
